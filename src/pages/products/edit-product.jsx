...
const EditProduct = () => {
    ...
    // Pre-filled product data (in real app, this would come from API)
    const productData = {
        name: "iPhone 15 Premium",
        brand: "Apple",
        category: "Electronics > Smartphones",
        description: "The latest iPhone with premium features and advanced camera system."
    };
                ...
                <div className="max-w-8xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <nav className="text-xs text-slate-500 dark:text-slate-400 mb-1 flex items-center gap-1">
                            ...
                            <ChevronRightIcon className="text-[14px]" />
                            <span className="font-medium text-slate-700 dark:text-slate-300">{productData.name}</span>
                        </nav>
                    ...
                    <div className="flex items-center gap-3">
                        <button 
                            ...
                            className="px-4 py-2 text-sm font-semibold border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors uppercase tracking-wide"
                        >
                            Cancel
                        </button>
                        <button 
                            onClick={() => {
                                // Save changes and navigate to product details
                ...
                <section className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-lg p-6 mui-shadow">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input 
                                className="w-full bg-transparent border-border-light dark:border-border-dark rounded focus:ring-primary focus:border-primary px-3 py-2.5" 
                                placeholder="e.g. Apple iPhone 15 (128GB) - Blue" 
                                type="text" 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select className="w-full bg-transparent border-border-light dark:border-border-dark rounded focus:ring-primary focus:border-primary px-3 py-2.5" defaultValue={productData.brand}>
                            ...
                            <div>
                                ...
                                <select className="w-full bg-transparent border-border-light dark:border-border-dark rounded focus:ring-primary focus:border-primary px-3 py-2.5" defaultValue={productData.category}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <div className="relative w-32 h-32 border border-border-light dark:border-border-dark rounded-lg overflow-hidden group">
                                <img alt="iPhone 15" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDjD7Ljb3cBxDW6sKcUoXtv_XhhHbucKqFuJ-6z4S3QgXfxHsfLhrEENzAubSqZSU6rXqrF8SDEga6STGZNkcenp8uVzD_yC6TsnBBSWsomkUKHapI_pfigxGFfw1rb0qUV_SOxsG8KW3oRTC74soJNOZwZCRxEl_CENhHLpY5oWU479E-FX6AzKG9i0e3BH5dceyYtf6eTLjz-ITdgd_xbVaHdcoWmy3p0bf4MnF_Z946Cd0w76z8PN7Cy0tHzazroKNieKoAguZtb" />
                            ...
                            <div className="relative w-32 h-32 border border-border-light dark:border-border-dark rounded-lg overflow-hidden group">
                                <img alt="iPhone 15" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAQge1jFVcVucXsVkbDzGWZNCDAG3UqlDGv3uoH5La33xhyU2Oh8M0yHRJkCOXtIUUPgzXcnjH6gTOEJ6Vcrw1-LICLtLwPWSpB2hNnAVE16-T06i5bDs7B08btcGkcOQJ0IgxjwQafAYu4G-5vkYkIDhwYleNO0Gq4LvtNix_9TvI3p-eCDx3UNLwzt4VxiGFp85ZcltCI-i188YSKY8fYWGx1JDf_BF4vCzFZcLP_sBM4alYQrHh08oWbHa9WL1Jo9Ccxx1fPMCM2" />
                                <button className="absolute top-1 right-1 bg-red-500 text-white p-0.5 rounded-full shadow hover:bg-red-600">
                                    <CloseIcon className="text-[14px]" />
                                </button>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-12 gap-4 items-end">
                                <div className="col-span-12 md:col-span-3">
                                    ...
                                    <input className="w-full bg-surface-light dark:bg-surface-dark border-border-light dark:border-border-dark rounded text-sm px-3 py-2" type="text" defaultValue="Storage" />
                                </div>
                            ...
                            <div className="grid grid-cols-12 gap-4 items-end">
                                <div className="col-span-12 md:col-span-3">
                                    <label className="block text-xs font-medium text-slate-500 uppercase tracking-wider mb-1">Attribute Name</label>
                                    <input className="w-full bg-surface-light dark:bg-surface-dark border-border-light dark:border-border-dark rounded text-sm px-3 py-2" type="text" defaultValue="Color" />
                                </div>
                                <div className="col-span-12 md:col-span-8">
                                    <label className="block text-xs font-medium text-slate-500 uppercase tracking-wider mb-1">Values</label>
                                    <div className="flex flex-wrap items-center gap-2 p-1.5 border border-border-light dark:border-border-dark rounded bg-surface-light dark:bg-surface-dark min-h-[40px]">
                            ...
                            <table className="w-full text-left text-sm border-collapse">
                                ...
                                <tbody className="divide-y divide-border-light dark:divide-border-dark">
                                    <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50">
                                        ...
                                        <td className="px-4 py-3"><input className="w-28 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="IP15-128-BL" /></td>
                                        <td className="px-4 py-3"><input className="w-24 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="79900" /></td>
                                        <td className="px-4 py-3">
                                            <select className="w-20 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" defaultValue="18%">
                                                <option>18%</option>
                                                <option>12%</option>
                                                <option>5%</option>
                                            </select>
                                        </td>
                                        <td className="px-4 py-3"><input className="w-16 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="50" /></td>
                                        <td className="px-4 py-3 text-center">
                                            <button className="text-slate-400 hover:text-red-500"><DeleteIcon fontSize="small" /></button>
                                        </td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50">
                                        <td className="px-4 py-3 font-medium">128GB / Titanium</td>
                                        <td className="px-4 py-3"><input className="w-28 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="IP15-128-TI" /></td>
                                        <td className="px-4 py-3"><input className="w-24 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="79900" /></td>
                                        <td className="px-4 py-3">
                                            <select className="w-20 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" defaultValue="18%">
                                                <option>18%</option>
                                        ...
                                        <td className="px-4 py-3"><input className="w-16 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="30" /></td>
                                        <td className="px-4 py-3 text-center">
                                            <button className="text-slate-400 hover:text-red-500"><DeleteIcon fontSize="small" /></button>
                                        </td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50">
                                        ...
                                        <td className="px-4 py-3"><input className="w-28 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="IP15-256-BL" /></td>
                                        <td className="px-4 py-3"><input className="w-24 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="89900" /></td>
                                        <td className="px-4 py-3">
                                            <select className="w-20 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" defaultValue="18%">
                                                <option>18%</option>
                                                <option>12%</option>
                                        ...
                                        <td className="px-4 py-3"><input className="w-16 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="20" /></td>
                                        <td className="px-4 py-3 text-center">
                                            <button className="text-slate-400 hover:text-red-500"><DeleteIcon fontSize="small" /></button>
                                        </td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50">
                                        ...
                                        <td className="px-4 py-3"><input className="w-28 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="IP15-256-TI" /></td>
                                        <td className="px-4 py-3"><input className="w-24 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="89900" /></td>
                                        <td className="px-4 py-3">
                                            <select className="w-20 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" defaultValue="18%">
                                                <option>18%</option>
                                        ...
                                        <td className="px-4 py-3"><input className="w-16 bg-transparent border-border-light dark:border-border-dark rounded text-xs px-2 py-1" type="text" defaultValue="15" /></td>
                                        <td className="px-4 py-3 text-center">
                                            <button className="text-slate-400 hover:text-red-500"><DeleteIcon fontSize="small" /></button>
                                        </td>
                                    </tr>
